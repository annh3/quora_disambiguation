...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        U = tf.get_variable("U", [self.config.max_len * self.config.embed_size, self.config.hidden_size], initializer=xavier,dtype=np.float32)
    ...
    def run_epoch(self, sess, train_examples1, dev_set1, train_examples2, dev_set2, train_sizes, dev_sizes):
        ...
        # for _ in range(10):
        #     loss, pred, norm = self.train_on_batch(sess, train_x1, train_x2, pad_size1, pad_size2, train_y)
